...
if(isset($_GET["id_producto"]) && !empty($_GET["id_producto"])){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        // Set parameters
        $param_id = trim($_GET["id_producto"]);
                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            ...
                            <p class="form-control-static"><?php echo $row["materialidad"]; ?></p>
                        </div><div class="form-group">
                            <label>piedra</label>
                            <p class="form-control-static"><?php echo $row["piedra"]; ?></p>
                        </div><div class="form-group">
                            <label>categoria_id</label>
                            <p class="form-control-static"><?php echo $row["categoria_id"]; ?></p>
                        </div>

                    <p><a href="producto-index.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>
        </div>
    </section>
